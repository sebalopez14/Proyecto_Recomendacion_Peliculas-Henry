...
def vectorizar_generos_por_fecha(combined_data, indice_pelicula, chunk_size=10000): #Se hace por "chunks" para abarcar el df por partes y reducir el uso de memoria
